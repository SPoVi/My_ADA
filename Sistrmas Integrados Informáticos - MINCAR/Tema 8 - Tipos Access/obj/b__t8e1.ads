...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_t8e1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e19b1ade#;
   pragma Export (C, u00001, "t8e1B");
   ...
   u00157 : constant Version_32 := 16#cd84495f#;
   pragma Export (C, u00157, "operacionesB");
   u00158 : constant Version_32 := 16#49dfaf3a#;
   pragma Export (C, u00158, "operacionesS");
