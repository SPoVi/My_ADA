...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_esbisiesto" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#0106347c#;
   pragma Export (C, u00001, "esbisiestoB");
   ...
   u00138 : constant Version_32 := 16#522bc5b6#;
   pragma Export (C, u00138, "system__val_boolB");
   u00139 : constant Version_32 := 16#628650b3#;
   pragma Export (C, u00139, "system__val_boolS");
