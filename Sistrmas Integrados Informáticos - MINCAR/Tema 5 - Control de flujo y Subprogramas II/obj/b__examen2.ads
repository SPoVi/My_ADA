...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_examen2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4f8d3978#;
   pragma Export (C, u00001, "examen2B");
   ...
   u00154 : constant Version_32 := 16#300056e8#;
