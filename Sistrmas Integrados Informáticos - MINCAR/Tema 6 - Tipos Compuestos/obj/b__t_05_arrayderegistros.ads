...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_t_05_arrayderegistros" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#172bb7b6#;
   pragma Export (C, u00001, "t_05_arrayderegistrosB");
