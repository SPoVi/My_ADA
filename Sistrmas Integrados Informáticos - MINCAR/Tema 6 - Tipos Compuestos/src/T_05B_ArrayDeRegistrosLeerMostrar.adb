...
procedure T_05B_ArraydeRegistrosLeerMostrar is
  ...
  begin
     ...
     put ("         Anio: ") ;
     get (rgUnEstudiante.rgCumpleaños.iAño) ; Skip_Line ;
     --put ("Nota en    Historia (0..100): ") ;
     --get (rgUnEstudiante.anNotas(Historia)) ; Skip_Line ;
     --put ("Nota en   Geografía (0..100): ") ;
     --get (rgUnEstudiante.anNotas(Geografía)) ; Skip_Line ;
     --put ("Nota en Matemáticas (0..100): ") ;
     --get (rgUnEstudiante.anNotas(Matemáticas)) ; Skip_Line ;
  ...
  begin
     ...
     put ("/") ;
      put (rgUnEstudiante.rgCumpleaños.iAño, 0) ;
      New_line ;
     --put ("Nota en    Historia (0..100): ") ;
     --put (rgUnEstudiante.anNotas(Historia)) ; Skip_Line ;
     --put ("Nota en   Geografía (0..100): ") ;
     --put (rgUnEstudiante.anNotas(Geografía)) ; Skip_Line ;
     --put ("Nota en Matemáticas (0..100): ") ;
     --put (rgUnEstudiante.anNotas(Matemáticas)) ; Skip_Line ;
	 for iAsignatura in T_afNotas'Range loop
        put ("Nota en ") ;
		put (iAsignatura, 12, Upper_case) ;
		put ("(0.0 .. 10.0): ") ;
