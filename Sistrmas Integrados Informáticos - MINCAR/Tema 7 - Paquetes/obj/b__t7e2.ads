...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_t7e2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8ef277eb#;
   pragma Export (C, u00001, "t7e2B");
   ...
   u00151 : constant Version_32 := 16#9e753330#;
   pragma Export (C, u00151, "matricesB");
   u00152 : constant Version_32 := 16#d9f59015#;
   pragma Export (C, u00152, "matricesS");
