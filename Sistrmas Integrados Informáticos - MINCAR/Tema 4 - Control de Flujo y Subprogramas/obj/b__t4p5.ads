...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_t4p5" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6da8212f#;
   pragma Export (C, u00001, "t4p5B");
   ...
   u00154 : constant Version_32 := 16#39d0dd9d#;
   ...
   u00158 : constant Version_32 := 16#4cc4aa18#;
